...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    public partial class MyCSharpNode : Node
    {
        ...
        [Signal] public delegate void MySignalWithParamsEventHandler();
...
.. code-block:: csharp
    ...
    myGDScriptNode.Connect("my_signal_with_params", Callable.From(new System.Action<string, int>(MySignalWithParamsHandler)));
    // Note that a System.Action must be explicitly created to avoid a "cannot convert from 'method group' to 'System.Action'" error.
